...
<head>
    ...
    <style>
        ...
        select {
            margin-bottom: 30px; /* Boşluk eklemek için */
        }
...
<body>
    ...
    <form action="{{ route('add') }}" method="post">
        ...
        <div class="container">
            <h2>Not Adı</h2>
            <input type="text" name="notname" placeholder="Not adı girin">
            ...
            <h2>Not İçeriği</h2>
            <textarea name="noticerik" placeholder="Not içeriğini buraya girin"></textarea>
            
            <button type="submit">Yeni not ekle</button>
        </div>
    </form>
</body>
</html>
